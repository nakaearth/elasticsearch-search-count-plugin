...
public class MojikanTokenizerFactory extends AbstractTokenizerFactory {
    ...
    public MojikanTokenizerFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
